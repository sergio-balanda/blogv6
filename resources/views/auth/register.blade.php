...
<div class="container">
    <div class="row justify-content-center mt-4">
        <div class="col-md-8">
            <div class="card card shadow mb-5 bg-white rounded">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-right">Imagen<br>
                            <span class="text-info text-small">* No requerida</span>
                            </label>
                            <div class="col-md-6">
